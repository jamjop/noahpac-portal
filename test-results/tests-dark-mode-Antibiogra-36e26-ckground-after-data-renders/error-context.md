...
- Name: tests/dark-mode.spec.ts >> Antibiogram page – dark mode >> abgram table th has dark background after data renders
- Location: tests/dark-mode.spec.ts:377:3
...
Call log:
  - navigating to "/antibiogram/", waiting until "load"
